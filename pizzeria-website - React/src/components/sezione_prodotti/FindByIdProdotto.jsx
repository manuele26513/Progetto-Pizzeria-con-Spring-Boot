...
<div>
  ...
  <br/>
        ...
        <br />
        <br />
        <button className="button button-green border-radius-50" type="button" onClick={() => byId("/resultFindByIdProdotto")}>
          Cerca
        </button>
        </div>
...
export default FindByIdProdotto